    ...
    return (
      <>
              ...
              <div className="col-12">
                <div className="menu_area">
                  <nav
                    ...
                    className={
                      this.state.nav < 20
                        ? "navbar  navbar-expand-lg align-items-center"
                        : "navbar scroll navbar-expand-lg align-items-center"
                    }
                  >
                    <Link2 className="navbar-brand" to="/">
                      <img
                        src="../common/img/landing/logo_white.png"
                        style={{ marginLeft: "40px", width: "75px" }}
                        alt="logo"
                      />
                    </Link2>
                    <button
                    ...
                    >
                      <ul className="navbar-nav animated" id="nav">
                        <li className="nav-item active">
                          <Link1 className="nav-link" smooth={true} to="/">
                            Home
                          </Link1>
                        </li>
        ...
        <section
          ...
          id="home"
          style={{
            backgroundImage: "url(../common/img/bg-img/welcome-bg.png)",
            zIndex: "1",
          }}
        ></section>
        <div className="row">
          ...
          <div className="col-xs-6 side-img">
            <Fade right duration={2000}>
              <img
                src="../common/img/bg-img/side.png"
