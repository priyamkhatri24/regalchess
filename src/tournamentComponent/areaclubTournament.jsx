...
class AreaclubTournament extends Component {
  state = {};
  render() {
    return (
            ...
            <div className="user-preview landscape">
              <div className="user-preview-info">
                <div className="user-short-description landscape teamvs  tiny padd-left-50">
                  ...
                  <p className="user-short-description-title">Royal King Club</p>
                ...
                <div className="user-preview-actions">
                  <div className="achievment-link">
                    <Link to="/user/area-club-tournament-detail">Register</Link>
                  </div>
                </div>
              </div>
            </div>
...
export default AreaclubTournament;
