...
class CoachDetail extends Form {
  state = {}
  render() {
    return (
            ...
            <div className="vip-video-details">
              ...
              <div className="video-description">
                ...
                <div className="school-registered">
                  ...
                  <p className="video-fees pull-right">Experience of years : <span>05 Years</span> </p>
                </div>
                <div className="text-center"><Link className="mr-5" to="/user/coaching-detail">Back</Link></div>
              </div>
            </div>
          </div>
        </div>
